...
INSERT INTO users (username , firstname , lastname , password , role) VALUES ('Moha' ,'Mohaned', 'Ashraf', '$2b$10$2dTaHEa2QPzJO7gRXKiweuM8/cLapX6cKzQPierKhU7.dj2j4IKp.'  , 'admin'); /* pass before hashing: pass123 */
INSERT INTO users (username , firstname , lastname , password , role) VALUES ('Hass' ,'Hassan', 'Ashraf', '$2b$10$f.k8.AT.U3Zy0pPXjwVGje0W2jy3/VfNUpMDYpw718dpvYXymJKFG', 'user'); /* pass before hashing: 123456 */
INSERT INTO users (username , firstname , lastname , password , role) VALUES ('kate22' ,'Kate', 'Mendes', '$2b$10$9XlShxGKgSG1CvYQIVaJv.2dpqUDuXIKhJtbIFJR.GE.MHU8j4wKG', 'user'); /* pass before hashing: 112233 */
INSERT INTO users (username , firstname , lastname , password , role) VALUES ('Mido' ,'Mohamed', 'Hassan', '$2b$10$Q1xUHTkb.1tP559tmVKU2ur6n4ZSf1b7wxJeLNzNLyStkEIFEcJc6', 'user'); /* pass before hashing: abc123 */
